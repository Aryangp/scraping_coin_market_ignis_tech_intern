...
"""
This is serailizing the models that are being created in models.py
"""
...
class OutputSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Output
        fields = [
            'price', 'price_change', 'market_cap', 'market_change', 'volume', 
            'volume_change', 'circulating_supply', 'total_supply', 'diluted_market_cap', 
            'contracts', 'official_links', 'socials'
        ]
